...
int main(int argc, char *argv[])
{
    ...
    initializeGame(N, M, K, player, time_left);

    //Game data stored in N, M, K, time_left
    ...
    if(player == 1)
    {
        ...
        //OUR CODE GiveMove(int& m, int& r, int& c)
        //cout<<"M1 : "<<m<<" R1: "<<r<<" C 1: "<<c<<endl;
        giveMove(m,r,c,moveAction);
        cout<<"After moves : "<<" M1 : "<<m<<" R1: "<<r<<" C 1: "<<c<<"Moveaction " << moveAction<<endl;
    ...
    while(x)
    {
        ...
        changeGameState(om, oro, oc);
        //OUR CODE TO UPDATE GAME STATE
    ...
    else if(d==2)
    {
        ...
        //OUR CODE TO CHANGE m,r,c
        cout<<"M2 : "<<m<<" R2 : "<<r<<" C2 : "<<c<<endl;
        giveMove(m,r,c, moveAction);
        cout<<"After moves : "<<" M2 : "<<m<<" R2: "<<r<<" C2: "<<c<<"Moveaction " << moveAction<<endl;
