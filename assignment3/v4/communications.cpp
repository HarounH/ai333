...
bool startminimax = false;
bool onlyminimax = false;
...
//		cout << "mypn " << gblState.mypn << " valid move : " << gblState.valid_move(iftwo) << endl;
		...
		else startminimax = true; 
	}

	if (gblState.plies/2==1 and !startminimax)
	{
...
//		cout << "mypn " << gblState.mypn << " valid move : " << gblState.valid_move(iftwo) << endl;
	...
	if (gblState.plies/2==2 and !startminimax)
	{
...
//		cout << "mypn " << gblState.mypn << " valid move : " << gblState.valid_move(iftwo) << endl;
	...
	if (gblState.plies/2==3 and !startminimax)
	{
		Move iftwo(1,7,5);
		Move ifone(1,3,5);
		//cout << "mypn " << gblState.mypn << " valid move : " << gblState.valid_move(iftwo) << endl;
	...
	// if (gblState.plies/2==4 and !startminimax)
// 	{
// 		Move iftwo(1,7,3);
// 		Move ifone(1,3,3);
// 		//cout << "mypn " << gblState.mypn << " valid move : " << gblState.valid_move(iftwo) << endl;
// 		if ((gblState.mypn==1) and gblState.valid_move(ifone)) best_move = ifone;
// 		else if ((gblState.mypn==2) and gblState.valid_move(iftwo)) best_move = iftwo;
// 		else startminimax = true;		// making it false, last hard coded move
// 	}
	
	// if (gblState.plies/2==5 and !startminimax)
	// {
	// 	Move iftwo(1,8,7);
	// 	Move ifone(1,3,7);
	// 	//cout << "mypn " << gblState.mypn << " valid move : " << gblState.valid_move(iftwo) << endl;
	...
	if (gblState.plies/2==4 ) onlyminimax=true;

	 	if (startminimax or onlyminimax) {cout << "yo" << endl;res = minimax(2,10);}
		m = best_move.m;
		r = best_move.r;
		c = best_move.c;
		res.m = best_move.m;
